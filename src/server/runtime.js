...
const aiTelemetry = new AiTelemetryStore();
const provider = new InstrumentedProvider(rawProvider, aiTelemetry);
export const runtime = {repository, tools, audit, provider, aiTelemetry, copilot:new CopilotOrchestrator({provider, tools, audit}), sessions:new SessionStore(), jiraConnections:new JiraConnectionStore()};

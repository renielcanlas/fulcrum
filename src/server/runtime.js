...
export const runtime = {repository, tools, audit, provider, aiTelemetry, persistence, configuration:new ConfigurationStore({persistence}), copilot:new CopilotOrchestrator({provider, tools, audit}), sessions:new SessionStore({persistence}), jiraConnections:new JiraConnectionStore({persistence})};
